...
@Component({
  selector: 'app-consulta-supervisor',
  standalone: true,
  imports: [
    RouterModule,
    MatDatepickerModule,
  ...
  templateUrl: './consulta-supervisor.component.html',
  styleUrl: './consulta-supervisor.component.css'
})
export class ConsultaSupervisorComponent {
  ...
  private Supervisor_api = environment.RutaApi.Apis.Consultas.Api.Supervisor;
  ...
  ObtenerEstados() {
    ...
    this.http.post(this.Supervisor_api, body, {headers: {'accept': '*/*'}})
    .subscribe(
      (data: any) => { 
        ...
        if(data.statusCode === 200) {
          ...
          this.router.navigateByUrl('/main/resultado-supervisor');
        }
