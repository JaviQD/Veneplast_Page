...
@Component({
  selector: 'app-resultado-supervisor',
  standalone: true,
  imports: [
    CommonModule,
    MatButtonModule
  ],
  templateUrl: './resultado-supervisor.component.html',
  styleUrl: './resultado-supervisor.component.css'
})
export class ResultadoSupervisorComponent implements OnInit{
  ...
  ObtenerEstados(estados: { [key: string]: boolean }) {
